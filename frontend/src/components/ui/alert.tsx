  ...
  "relative w-full rounded-lg border px-4 py-3 text-sm [&>svg]:absolute [&>svg]:left-4 [&>svg]:top-4 [&>svg]:size-4 [&>svg~*]:pl-7",
  {
    variants: {
      variant: {
        ...
        warning:
          "border-warning/40 bg-warning-subtle text-warning [&>svg]:text-warning",
        danger: "border-danger/30 bg-danger-subtle text-danger [&>svg]:text-danger",
        ai: "border-ai/30 bg-ai-subtle text-ai [&>svg]:text-ai",
        premium:
          "border-premium/40 bg-premium-subtle text-premium [&>svg]:text-premium",
      },
    },
