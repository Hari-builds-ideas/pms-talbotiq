...
const sheetVariants = cva(
  // overflow-y-auto + safe-area padding: a side panel holding a form on a phone
  // has to scroll itself and clear the notch/home indicator, or its action row
  // ends up under the system UI with no way to reach it.
  "fixed z-50 flex flex-col gap-4 overflow-y-auto bg-card pb-safe-4 pt-safe shadow-lg transition ease-in-out data-[state=closed]:duration-200 data-[state=open]:duration-300 data-[state=open]:animate-in data-[state=closed]:animate-out",
  {
    variants: {
      side: {
